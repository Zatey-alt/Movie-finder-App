...
export class DataService {
  ...
  getMovieTrailers(movieTitle: string): Observable<any> {
    const apiUrl = `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${encodeURIComponent(movieTitle + ' trailer')}&type=video&key=${environment.youtubeApiKey}`;
